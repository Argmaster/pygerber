"""Parser tests for Aperture Macros."""
...
@pytest.mark.parametrize(
    ["directory", "file_name"],
    sorted(find_gerberx3_asset_files("test/assets/gerberx3/expressions/AM/")),
)
def test_sample(asset_loader: AssetLoader, directory: Path, file_name: str) -> None:
    """Test tokenizer on sample gerber code."""
    stack = tokenize_gerberx3(asset_loader, directory, file_name, only_expressions=True)
