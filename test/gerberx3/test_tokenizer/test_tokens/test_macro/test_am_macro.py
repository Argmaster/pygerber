...
def test_sample_am_sample_0(asset_loader: AssetLoader) -> None:
...
def test_sample_am_sample_0b(asset_loader: AssetLoader) -> None:
...
def test_sample_am_sample_1(asset_loader: AssetLoader) -> None:
...
def test_sample_am_sample_2(asset_loader: AssetLoader) -> None:
