...
(from our repo) and save it as PNG named "render.png" we can use
following command:
...
:ref:`usage/specfile:Project Specification files` chapter.
...
different set of parameters. Again, see :ref:`usage/specfile:Project
Specification files` chapter for more in-depth description. (DRY :D )
...
:ref:`usage/specfile:Project Specification files`. If you did, you
should already be aware of the meaning of this file's structure.
